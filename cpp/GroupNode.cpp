...
extern "C"
{
	...
	PARQUETSHARP_EXPORT ExceptionInfo* GroupNode_Field_Index_By_Name(const std::shared_ptr<schema::GroupNode>* group_node, const char* const name, const size_t name_length, int* index)
	{
		TRYCATCH(
